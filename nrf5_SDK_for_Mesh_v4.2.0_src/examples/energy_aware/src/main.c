...
void getfirstTask(){
    ...
    application_dofile("C:/Users/IDLab guest/Documents/GitHub/BLUESS_BLE/nrf5_SDK_for_Mesh_v4.2.0_src/examples/energy_aware/src/tasks.json", "C:/Users/IDLab guest/Documents/GitHub/BLUESS_BLE/nrf5_SDK_for_Mesh_v4.2.0_src/examples/energy_aware/src/tasksflow.json");
...
void sleep_timer_handler(void *m_notused){
    ...
    __LOG(LOG_SRC_APP, LOG_LEVEL_INFO, "Voltage is: %d \n", voltage);
